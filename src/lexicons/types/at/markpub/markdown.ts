...
import * as AtMarkpubText from './text.js';

const _mainSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(/*#__PURE__*/ v.literal('at.markpub.markdown')),
  /**
   ...
   */
  flavor: /*#__PURE__*/ v.optional(/*#__PURE__*/ v.string<'commonmark' | 'gfm' | (string & {})>()),
  /**
   ...
   */
  renderingRules: /*#__PURE__*/ v.optional(/*#__PURE__*/ v.string()),
  /**
   ...
   */
  get text() {
    return AtMarkpubText.mainSchema;
  },
});
